...
export interface IMasterState {
  ...
  cityLatLong: ICityLatLong[];
  Information: ISearchInformation;
  InformationButtons: ILocationButtons[];
  GoogleResult: IGoogleResult;
  TopSights: ITopSights;
  ImgurResult: IImgurResult;
  GoogleImgResult: IGoogleImgResult;
  ChatGPTResponse: IChatGPTResponse[];
}
...
export enum Types {
  MASTER_GET_GOOGLE_RESULT = 'MASTER_GET_GOOGLE_RESULT',
  MASTER_GET_GOOGLE_RESULT_SUCCESS = 'MASTER_GET_GOOGLE_RESULT_SUCCESS',
  MASTER_GET_INFORMATION_RESULT_SUCCESS = 'MASTER_GET_INFORMATION_RESULT_SUCCESS',
  MASTER_GET_INFORMATION_BUTTONS_SUCCESS = 'MASTER_GET_INFORMATION_BUTTONS_SUCCESS',
  MASTER_GET_TOPSIGHTS_SUCCESS = 'MASTER_GET_TOPSIGHTS_SUCCESS',

  MASTER_GET_IMG_URL = 'MASTER_GET_IMG_URL',
  MASTER_GET_IMG_URL_SUCCESS = 'MASTER_GET_IMG_URL_SUCCESS',

  MASTER_GET_GOOGLE_IMG_RESULT = 'MASTER_GET_GOOGLE_IMG_RESULT',
  MASTER_GET_GOOGLE_IMG_RESULT_SUCCESS = 'MASTER_GET_GOOGLE_IMG_RESULT_SUCCESS',

  MASTER_GET_CITY_LATLONG = 'MASTER_GET_CITY_LATLONG',
  MASTER_GET_CITY_LATLONG_SUCCESS = 'MASTER_GET_CITY_LATLONG_SUCCESS',

  MASTER_SEND_MESSAGES_TO_CHATGPT = 'MASTER_SEND_MESSAGES_TO_CHATGPT',
  MASTER_SEND_MESSAGES_TO_CHATGPT_SUCCESS = 'MASTER_SEND_MESSAGES_TO_CHATGPT_SUCCESS',
...
export interface IGetImgUrl {
  type: Types.MASTER_GET_IMG_URL;
  payload: IImgModel;
}

export interface IGetImgUrlSuccess {
  type: Types.MASTER_GET_IMG_URL_SUCCESS;
  payload: {ImgurResult: IImgurResult};
}

export interface IGetGoogleResult {
  type: Types.MASTER_GET_GOOGLE_RESULT;
  payload: {query: string, lang: string};
}

export interface IGetGoogleImgResult {
  type: Types.MASTER_GET_GOOGLE_IMG_RESULT;
  payload: {imglink: string, lang: string};
}

export interface IGetGoogleImgResultSuccess {
  type: Types.MASTER_GET_GOOGLE_IMG_RESULT_SUCCESS;
  payload: {GoogleImgResult: IGoogleImgResult};
}

export interface IGetGoogleResultSuccess {
  type: Types.MASTER_GET_GOOGLE_RESULT_SUCCESS;
  payload: {GoogleResult: IGoogleResult};
}

export interface IGetInformationSuccess {
  type: Types.MASTER_GET_INFORMATION_RESULT_SUCCESS;
  payload: {Information: ISearchInformation};
}

export interface IGetInformationButtonsSuccess {
  type: Types.MASTER_GET_INFORMATION_BUTTONS_SUCCESS;
  payload: ILocationButtons[]
}

export interface IGetTopSightsSuccess {
  type: Types.MASTER_GET_TOPSIGHTS_SUCCESS;
  payload: {TopSights: ITopSights}
}


export interface IGetCityLatLong {
  type: Types.MASTER_GET_CITY_LATLONG;
  payload: {cityname: string};
}

export interface IGetCityLatLongSuccess {
  type: Types.MASTER_GET_CITY_LATLONG_SUCCESS;
  payload: ICityLatLong[]
}
...
export interface ISendMessagesToChatGPT {
  type: Types.MASTER_SEND_MESSAGES_TO_CHATGPT;
  payload: {prompt: string, max_tokens: number};
}

export interface ISendMessagesToChatGPTSuccess {
  type: Types.MASTER_SEND_MESSAGES_TO_CHATGPT_SUCCESS;
  payload: IChatGPTResponse[]
}

export type MasterActionsType =
  | ISendMessagesToChatGPTSuccess
  | IGetImgUrlSuccess
  | IGetGoogleResultSuccess
  | IGetGoogleImgResultSuccess
  | IGetInformationSuccess
  | IGetTopSightsSuccess
  | IGetInformationButtonsSuccess
  | IGetCityLatLongSuccess
