...
import {
  ...
  ISendMessagesToChatGPT,
  ISendMessagesToChatGPTSuccess,
} from './master.types';

const MasterActions = {

  sendMessagesToChatGPT: (prompt: string, max_tokens: number): ISendMessagesToChatGPT => { 
    return {
  ...
  sendMessagesToChatGPTSuccess: (ChatGPTResponse: IChatGPTResponse[]): ISendMessagesToChatGPTSuccess => ({
    type: Types.MASTER_SEND_MESSAGES_TO_CHATGPT_SUCCESS,
    payload: ChatGPTResponse
  }),

  getImgUrl: (ImgModel: IImgModel): IGetImgUrl => {
    return {
  ...
  getImgUrlSuccess: (ImgurResult: IImgurResult): IGetImgUrlSuccess => {
    return {
  ...
  getGoogleImgResult: (imglink: string, lang: string): IGetGoogleImgResult => {
    return {
      type: Types.MASTER_GET_GOOGLE_IMG_RESULT,
      payload: {imglink, lang}
    };
  },

  getGoogleImgResultSuccess: (GoogleImgResult: IGoogleImgResult): IGetGoogleImgResultSuccess => {
    return {
      type: Types.MASTER_GET_GOOGLE_IMG_RESULT_SUCCESS,
      payload: {GoogleImgResult}
    };
  },

  getGoogleResult: (query: string, lang: string): IGetGoogleResult => {
    return {
  ...
  getGoogleResultSuccess: (GoogleResult: IGoogleResult): IGetGoogleResultSuccess => {
    return {
  ...
  getInformationSuccess: (Information: ISearchInformation): IGetInformationSuccess => {
    return {
  ...
  getTopSights: (TopSights: ITopSights): IGetTopSightsSuccess => {
    return {
  ...
  getInformationButtonsSuccess: (InformationButtons: ILocationButtons[]): IGetInformationButtonsSuccess => {
    return {
      type: Types.MASTER_GET_INFORMATION_BUTTONS_SUCCESS,
      payload: InformationButtons
    };
  },

  getCityLatLong: (cityname: string): IGetCityLatLong => {
    return {
  ...
  getCityLatLongSuccess: (cityLatLong: ICityLatLong[]): IGetCityLatLongSuccess => {
    return {
